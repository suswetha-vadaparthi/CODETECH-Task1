...
async function getWeather() {
    try {
        ...
        const currentWeatherIconCode =
            dailyForecast[new Date().toLocaleDateString("en-US", { weekday: "long" })].icon;
        ...
        document.querySelector(".humidity .value").textContent =
            dailyForecast[new Date().toLocaleDateString("en-US", { weekday: "long" })].humidity + " %";
        document.querySelector(".wind .value").textContent =
            dailyForecast[new Date().toLocaleDateString("en-US", { weekday: "long" })].windSpeed + " m/s";
